...
CodexにPR作成まで依頼する場合、PR本文には以下を含める。

- 実施したこと。
- 実施しなかったこと。
- 変更ファイル一覧。
- 公開安全性確認結果。
- 表示確認、リンク確認、CI確認などの確認手順と結果。
- 未反映事項がある場合は、未反映として明記すること。

公開安全性確認結果では、個人情報、実企業名、顧客名、内部システム名、守秘義務に触れる詳細仕様、秘密情報が新たに混入していないことを確認対象に含める。
